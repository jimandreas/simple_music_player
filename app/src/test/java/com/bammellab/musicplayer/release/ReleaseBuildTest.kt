...
package com.bammellab.musicplayer.release
...
class ReleaseBuildTest {
    ...
    private fun findModuleRoot(): File? {
        // Try to find the app module root
        ...
        for (path in possiblePaths) {
            ...
            if (buildFile.exists() && buildFile.readText().contains("com.bammellab.musicplayer")) {
    ...
    fun verifyReleaseBundleContainsMappingFile() {
        ...
        assumeTrue(
            aabFile != null,
            "Skipping: No release AAB found. Run './gradlew.bat :app:bundleRelease' first."
        )
        ...
        ZipFile(aabFile).use { zip ->
            ...
            // com.bammellab.musicplayer.SomeClass -> a.b.c:
